...
<header>
    <div id="header">
        <div class="connect"><a class="waves-effect waves-light btn modal-trigger teal darken-3" href="#formConnect">Espace
                Connexion</a>
        </div>
...
<div id="formConnect" class="modal">
    <div class="modal-content">
        <?php include "public/pages/connect.php"; ?>
    </div>
