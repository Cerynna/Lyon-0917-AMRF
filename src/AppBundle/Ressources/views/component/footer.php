<div class="bck">
    ...
    <div class="container-fluid bck-footer">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <ul>
                            ...
                            <li><a class="" href="?page=MentionsLegales">Mantions Légales</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <ul>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <img class="partlogo" src="dist/img/partnaires/groupe_cdd.png" alt="">
                        <img class="partlogo" src="dist/img/partnaires/panneaupocket.png" alt="">
                    </div>
                </div>
            </div>
        </div>
