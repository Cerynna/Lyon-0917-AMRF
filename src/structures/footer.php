	<div class="row">
		<div class="col m1">
		<img class="responsive-img partlogo" src="dist/img/AMRF.png">
		</div>
		<div class="col m11 center-align">
	...
	<div class="row center-align">
		...
		<div class="col m4">
			<ul>
				<li><a class="grey-text text-lighten-3" href="?page=planDuSite">Plan du Site</a></li>
			</ul>
		</div>
    </div>
</div>
