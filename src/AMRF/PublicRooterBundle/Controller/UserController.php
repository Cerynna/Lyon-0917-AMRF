...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('AMRFPublicRooterBundle:User')->findAll();
    ...
    {
        $user = new User();
        $form = $this->createForm('AMRF\PublicRooterBundle\Form\UserType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('AMRF\PublicRooterBundle\Form\UserType', $user);
