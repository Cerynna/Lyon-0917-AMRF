...
use AMRF\PublicRooterBundle\Entity\PublicPage;
...
class PublicPageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $publicPages = $em->getRepository('AMRFPublicRooterBundle:PublicPage')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AMRF\PublicRooterBundle\Form\PublicPageType', $publicPage);
    ...
    {
        $deleteForm = $this->createDeleteForm($publicPage);
        $editForm = $this->createForm('AMRF\PublicRooterBundle\Form\PublicPageType', $publicPage);
