...
class DictionaryController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AMRF\PublicRooterBundle\Form\DictionaryType', $dictionary);
    ...
    {
        $deleteForm = $this->createDeleteForm($dictionary);
        $editForm = $this->createForm('AMRF\PublicRooterBundle\Form\DictionaryType', $dictionary);
