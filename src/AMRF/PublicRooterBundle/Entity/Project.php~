 ...
 * @ORM\Entity(repositoryClass="AMRF\PublicRooterBundle\Repository\ProjectRepository")
 */
class Project
{
    /**
     ...
     * Set favoriteProject
     *
     * @param \AMRF\PublicRooterBundle\Entity\Favorite $favoriteProject
     *
     * @return Project
     */
    public function setFavoriteProject(\AMRF\PublicRooterBundle\Entity\Favorite $favoriteProject = null)
    {
