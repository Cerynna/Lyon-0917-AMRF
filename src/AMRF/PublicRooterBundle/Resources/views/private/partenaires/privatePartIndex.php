...
<div class="row">
    <div class="card cardGest col-xs-12 col-md-4">
        <div class="card-body bck-part">
            ...
            <div class="card-block">
                <button class="btn btn-sm"><a href="#"><span class="fa fa-pencil"></span> ACCEDER</a></button>
            </div>
        </div>
    </div>
    <div class="card cardGest col-xs-12 col-md-4">
        <div class="card-body bck-part">
            ...
            <div class="card-block">
                      <button class="btn btn-sm"><a href="#"><span class="fa fa-search"></span>
                        CONSULTER</a></button>
            </div>
        </div>
    </div>
    <div class="card cardGest col-xs-12 col-md-4">
        <div class="card-body bck-part">
            ...
            <div class="card-block ">
                <button class="btn btn-sm"><a href="#"><span class="fa fa-pencil"></span> ACCEDER A MON PROFIL</a></button>
