...
<div id="accordion" role="tablist">
    ...
    <div class="card">
        ...
        <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
            <div class="card-body">
                Les informations personnelles collectées sur ce Site sont utilisées pour le fonctionnement du Site et pour nous permettre de vous fournir le service ou de mener à bien la transaction que vous avez demandé ou autorisé.
    ...
    <div class="card">
        ...
        <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
            <div class="card-body">
                Sauf indication contraire dans cette déclaration, les informations personnelles que vous fournissez sur le Site ne seront pas transmises en dehors de ses filiales et partenaires sans votre autorisation. Tel que décrit dans la section qui suit, vous pouvez accéder à vos informations personnelles et choisir comme vous souhaitez être contacté.
    ...
    <div class="card">
        ...
        <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingFour" data-parent="#accordion">
            <div class="card-body">
                Vous pouvez rectifier vos données personnelles et vos informations de contact sur ce Site après vous être identifié.
    ...
    <div class="card">
        ...
        <div id="collapseEight" class="collapse" role="tabpanel" aria-labelledby="headingEight" data-parent="#accordion">
            <div class="card-body">
                Si vous avez des questions concernant cette déclaration, contactez-nous par le biais du formulaire que nous mettons à votre disposition auquel vous avez accès après vous être identifié.
            </div>
        </div>
    </div>
    <div class="card">
    ...
    <div class="card">
        ...
        <div id="collapseTen" class="collapse" role="tabpanel" aria-labelledby="headingTen" data-parent="#accordion">
            <div class="card-body">
                Vos commentaires concernant cette déclaration de confidentialité sont les bienvenus. Si vous estimez que notre Site n'a pas respecté cette déclaration de confidentialité, contactez-nous par voie électronique ou par courrier postal à l'adresse se trouvant sur les conditions d'utilisation, et nous userons de tous moyens raisonnables pour rapidement déterminer le problème et y remédier.
            </div>
        </div>
    </div>