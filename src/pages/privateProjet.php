...
<div class="row">
    <div class="theme-city">
                 ...
                 <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">Site internet : http://www.lesmolieres.fr</li>
                        </ul>
                    </div>
                 </div>
             </div>
        ...
        <div class="col-md-2"> <!-- handle img size control-->
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTT14TOAD23UWsZ5wqXt1YIZ7Kwu9_03duV98CKb279UDkAidrZg" class="img-thumbnail">
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="panel panel-default">
    <div class="panel-heading" id="headingList">Pour plus d'informations</div>
    <ul class="list-group">
